...
/** component-methods.md: ConnectionSchemaComponent. */
public interface ConnectionSchemaService {
    ...
    SchemaImportResult importSchema(Long connectionId, Long actorUserId);

    List<SchemaView> getSchema(Long connectionId);

    boolean isSchemaAllowed(Long connectionId, String schemaName);
